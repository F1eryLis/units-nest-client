import { Circle, Delete, PlayArrow, Stop, Upload } from "@mui/icons-material";
import { Box, IconButton, LinearProgress, Sheet, Stack, Typography } from "@mui/joy";
import { Dispatch, SetStateAction, useEffect, useState } from "react";
import { v4 as uuidv4 } from 'uuid';
import AudioVisualizer from "./AudioVisualizer";
import { useGetSoundFilesQuery } from "../__generated__/graphql";
...
export default function RecordingsList({ audio }: RecordingsListProps) {
    ...
    const { data } = useGetSoundFilesQuery();
