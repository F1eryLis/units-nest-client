...
import { GetKanbanColumnsDocument, useCreateKanbanColumnMutation } from "../../__generated__/graphql";
...
const CreateColumnModal: React.FC<CreateColumnModalProps> = ({ open, onClose }) => {
    ...
    const [createColumn] = useCreateKanbanColumnMutation();
