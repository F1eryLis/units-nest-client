...
import { Modal, ModalDialog, ModalClose, Sheet, Button, FormControl, FormLabel, Input, ListItemContent, Typography, List, ListItem, Stack, IconButton, ListDivider, Tab, Tabs, TabList, TabPanel, tabClasses } from '@mui/joy';
import { Create, Delete, Close, Done } from '@mui/icons-material';
import { IMaskInput } from 'react-imask';
import * as XLSX from 'xlsx';
import { GetPhoneListsDocument, useCreatePhoneListMutation } from '../../__generated__/graphql';
...
const TextMaskAdapter = forwardRef<HTMLInputElement, CustomProps>(
...
const CreatePhoneModal: FC<CreatePhoneModalProps> = (({ open, onClose }) => {
    const [phonesList, setPhonesList] = useState<string[]>([]);
    const [phoneNumber, setPhoneNumber] = useState<string>('');
    const [phoneBase, setPhoneBase] = useState<string>('');
    const [editIndex, setEditIndex] = useState<number | null>(null);
    const [editPhone, setEditPhone] = useState<string>('');
    const [sheetUrl, setSheetUrl] = useState<string>('');
    const [pastedData, setPastedData] = useState<string>('');
    const [copyPasteData, setCopyPasteData] = useState<string>('');
    const [selectedFile, setSelectedFile] = useState<string>('');

    const [createPhoneList] = useCreatePhoneListMutation({
        refetchQueries: [{
            query: GetPhoneListsDocument,
        }],
    });
    ...
    return (
        ...
        >
            ...
            >
                ...
                <FormControl>
                    <Button
                        onClick={() => handleAddPhone(phoneNumber)}
                    >
                        Добавить номер
                    </Button>
                </FormControl>
